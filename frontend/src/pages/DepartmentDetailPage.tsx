  ...
  useEffect(() => {
    if (id) {
      api.get(`/departments/${id}`)
        ...
        .catch(() => toast.error('Failed to fetch department details.'))
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-2xl shadow-xl border-2 border-green-100 p-6 md:p-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                <DocumentTextIcon className="w-7 h-7 text-green-600 mr-3" />
                Department Details
              </h2>
          ...
          <div className="lg:col-span-1">
            <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl shadow-xl p-6 md:p-8 text-white">
              <div className="text-center">
                ...
                <p className="text-5xl font-extrabold">{department.employees.length}</p>
              </div>
            </div>
          </div>
        </div>

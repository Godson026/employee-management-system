...
export default function DepartmentsListPage() {
  ...
  useEffect(() => {
    const fetchDepartments = async () => {
      try {
        ...
        setError('Failed to fetch departments. Is the backend server running?');
      } finally {
        setLoading(false);
      }
    };
  ...
  const DepartmentCard = ({ department }: { department: Department }) => (
    <div className="group bg-white rounded-2xl shadow-lg border border-slate-200 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden">
      ...
      <div className="relative p-6 bg-gradient-to-br from-blue-50 to-indigo-50 border-b border-slate-100">
        <div className="flex items-start justify-between">
          <div className="flex items-center space-x-4">
            <div className="w-16 h-16 bg-gradient-to-br from-blue-500 via-indigo-600 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-sm text-slate-500 truncate font-medium">Code: {department.code}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm font-medium text-slate-600">Department Code</span>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-sm font-medium text-slate-600">Department Head</span>
            </div>
      ...
      <div className="bg-white border-b border-gray-200 shadow-sm">
        <div className="px-8 py-12">
          <div className="max-w-7xl mx-auto">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-4xl font-bold mb-4 text-gray-900">Organizational Departments</h1>
                <p className="text-xl text-gray-600 max-w-2xl">
                  Manage your organizational structure, department hierarchies, and team leadership across your organization.
                </p>
              </div>
              <Link
                to="/departments/new"
        ...
        <div className="space-y-8">
          {loading && (
            <div className="flex items-center justify-center py-20">
              <div className="flex items-center space-x-4">
                ...
                <span className="text-xl text-slate-600 font-medium">Loading departments...</span>
              </div>
            </div>
          )}
          ...
          {!loading && !error && (!departments || departments.length === 0) && (
            <div className="text-center py-20">
              ...
              <h3 className="text-2xl font-bold text-slate-800 mb-4">No departments found</h3>
              <p className="text-slate-600 text-lg mb-8">Get started by creating your first organizational department to structure your team.</p>
              <Link
                to="/departments/new"
                className="inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl hover:shadow-xl transform hover:-translate-y-1 transition-all duration-200"
              >
